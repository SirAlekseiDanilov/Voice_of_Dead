...
namespace VoD {
    ...
    public class SpaceShip : Destructible {
        ...
        public void HalfMaxLinearVelocity() {
            if (m_MaxLinearVelocityBackup < 0.001f) { m_MaxLinearVelocityBackup = m_MaxLinearVelocity; }
            if (m_MaxLinearVelocity < 0.8f) { return; }
            m_MaxLinearVelocity /= 2;
        }
        //public void HalfMaxLinearVelocity()
        //{
        //    if (m_MaxLinearVelocityBackup == 0)
        //    { m_MaxLinearVelocityBackup = m_MaxLinearVelocity; }
        //    m_MaxLinearVelocity /= 2;
        //}
        public void RestoreMaxLinearVelocity() {
            if (m_MaxLinearVelocityBackup != 0)
                m_MaxLinearVelocity = m_MaxLinearVelocityBackup;
        }
        ...
        private void UpdateRigidbody() {
            ...
            //print($"{-m_Rigid.velocity} {m_Thrust} {m_MaxLinearVelocity}"); // форматированная строка
        ...
        */
        ...
        public override void Use(EnemyAsset asset) {
            // Устанавливаю скорость перемещения.
            m_MaxLinearVelocity = asset.moveSpeed;
            // Передаю команду "наверх" по установке жизней.
            base.Use(asset);
        }
