...
namespace VoD {
    ...
    public class Projectile : Entity {
        ...
        public void SetFromOtherProjectile(Projectile other) {
            other.GetData(out m_Velocity, m_Lifetime, m_Damage, m_ImpactEffectPrefab);
        }

        private void GetData(out float m_Velocity, float m_Lifetime, int m_Damage, ImpactEffect m_ImpactEffectPrefab) {
    ...
    public class ProjectileInspector : Editor {
        public override void OnInspectorGUI() {
            ...
            if (GUILayout.Button("Create TD Projectile")) {
                ...
                var tdProj = target.gameObject.AddComponent<Projectile_>();
